<header class="navbar navbar-inverse">
            ...
            <!-- Logo -->
            <a href="index.html" class="navbar-brand"><img src="{{ asset('img/template/logo.png') }}" alt="logo"></a>
            ...
            <ul id="widgets" class="navbar-nav-custom pull-right">
                        ...
                        <li class="li-hover">
                            <div class="media">
                                <a class="pull-left" href="javascript:void(0)">
                                    <img src="{{ asset('img/placeholders/image_dark_64x64.png') }}" alt="fakeimg">
                                </a>
                ...
                <li id="messages-widget" class="dropdown dropdown-left-responsive">
                    ...
                    <ul class="dropdown-menu dropdown-menu-right widget">
                        ...
                        <li class="new-on">
                            <div class="media">
                                <a class="pull-left" href="javascript:void(0)">
                                    <img src="{{ asset('img/placeholders/image_light_64x64.png') }}" alt="fakeimg">
                                </a>
                                <div class="media-body">
                ...
                <li class="dropdown pull-right dropdown-user">
                    <a href="javascript:void(0)" class="dropdown-toggle" data-toggle="dropdown"><img src="{{ asset('img/template/avatar.png') }}" alt="avatar"> <b class="caret"></b></a>
