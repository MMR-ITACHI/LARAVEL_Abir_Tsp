...
<form id="form-validation" action="{{route('manager.store') }}" method="post" class="form-horizontal form-box remove-margin" enctype="multipart/form-data">
    @csrf
    <!-- Form Header -->
    <h4 class="form-box-header">Manager Adding </h4>
    ...
    <div class="form-box-content">
        ...
        <div class="form-group">
            <label class="control-label col-md-2" for="val_password">Manager Phone Number *</label>
            <div class="col-md-3">
                <div class="input-group">
        ...
        <div class="form-group">
            <label class="control-label col-md-2" for="val_password">Confirm Password *</label>
            <div class="col-md-3">
                <div class="input-group">
                    <span class="input-group-addon"><i class="fa fa-asterisk fa-fw"></i></span>
