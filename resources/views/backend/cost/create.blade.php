...
<form id="form-validation" action="{{route('cost.store') }}" method="post" class="form-horizontal form-box remove-margin" enctype="multipart/form-data">
    @csrf
    <!-- Form Header -->
    <h4 class="form-box-header">Cost Adding </h4>
    ...
    <div class="form-group">
            ...
            <div class="col-md-3">
                <select name="unit_name" id="">
                    ...
                    <option value="{{$unit->id}}" @selected(old('unit_name')==$unit->id)>{{$unit->name}}</option>
        ...
        <div class="form-group">
            ...
            <div class="col-md-3">
                <div class="input-group">
                    ...
                    <input type="text" id="val_username" name="cost" class="form-control">
                    @error('cost')
					<div class="alert alert-danger">{{$message}}</div>
					@enderror
                </div>
