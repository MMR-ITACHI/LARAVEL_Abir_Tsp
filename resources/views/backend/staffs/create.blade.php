...
<form id="form-validation" action="{{route('staff.store') }}" method="post" class="form-horizontal form-box remove-margin" enctype="multipart/form-data">
    @csrf
    <!-- Form Header -->
    <h4 class="form-box-header">Staff Adding </h4>
