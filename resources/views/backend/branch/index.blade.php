...
<ul id="nav-info" class="clearfix">
                        ...
                        <li class="active"><a href="{{ url('admin/branch') }}">BranchList</a></li>
                        
                    </ul>

@section('content')

<h3 class="page-header page-header-top"> <a href="{{route('branch.create')}}" class="btn btn-success ">Add Branch</a> <br>  Branches List <small>All information about Branches</small></h3>
