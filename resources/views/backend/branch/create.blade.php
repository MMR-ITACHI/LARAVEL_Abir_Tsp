...
<form id="form-validation" action="{{route('branch.store') }}" method="post" class="form-horizontal form-box remove-margin" enctype="multipart/form-data">
    @csrf
    <!-- Form Header -->
    <h4 class="form-box-header">Branch Adding </h4>
        ...
        <div class="form-group">
            ...
            <div class="col-md-3">
                <div class="input-group">
                    ...
                    <input type="text" id="val_email" name="email" class="form-control">
                    @error('email')
																	<div class="alert alert-danger">{{$message}}</div>
																	@enderror
                </div>
        ...
        <div class="form-group">
            ...
            <div class="col-md-3">
                <div class="input-group">
                    ...
                    <input type="number" id="password" name="number" class="form-control">
                    @error('number')
																	<div class="alert alert-danger">{{$message}}</div>
																	@enderror
                </div>
        ...
        <div class="form-group">
            ...
            <div class="col-md-3">
                <div class="input-group">
                    ...
                    <textarea type="text" class="form-control" id="exampleInputEmail_4" name="address" rows="10" placeholder="Enter details"></textarea>
                    @error('address')
																	<div class="alert alert-danger">{{$message}}</div>
																	@enderror
